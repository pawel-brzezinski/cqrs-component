...
use PB\Component\CQRS\Symfony\PasswordHasher\Argon2IDPasswordHasher;
...
{
    ###################################################
    # Argon2IDPasswordHasher::getValueObjectClass()   #
    #                                                 #
    ...
    public function testShouldCallGetValueObjectProtectedMethodAndCheckIfReturnedStringIsCorrect(): void
    {
        ...
        // Then
        $this->assertSame(Argon2IDHashedPassword::class, $actual);
    }
    ...
    public function testShouldCallHashMethodAndCheckIfPlainPasswordHasBeenHashedCorrectly(): void
    {
        ...
        $voFromActual = Argon2IDHashedPassword::fromHash($actual);
    ...
    #########################################
    # Argon2IDPasswordHasher::needsRehash() #
    #########################################
     ...
     */
    private function createHasher(): Argon2IDPasswordHasher
    {
