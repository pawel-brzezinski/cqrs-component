 ...
 */
final class SimpleFloatMother extends SimpleValueObjectMother
{
    use FakerTrait;
    ...
    {
        return SimpleFloat::create(...array_values(self::randomConstructorArguments($args)));
    }

    /**
     * @throws AssertionFailedException
     */
    public static function create(float $value): SimpleFloat
    {
    ...
    {
        return [
            'value' => self::getFaker()->randomFloat(2, -100, 100),
        ];
    }
}
