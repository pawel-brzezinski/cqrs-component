 ...
 */
final class PositiveFloatMother extends SimpleValueObjectMother
{
    use FakerTrait;
    ...
    {
        return PositiveFloat::create(...array_values(self::randomConstructorArguments($args)));
    }

    /**
     * @throws AssertionFailedException
     */
    public static function create(float $value): PositiveFloat
    {
    ...
    {
        return [
            'value' => self::getFaker()->randomFloat(2, 1, 100),
        ];
    }
}
